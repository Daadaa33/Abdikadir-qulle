    ...
    <div className="pt-[5rem] max-w-4xl mx-auto  flex flex-col items-center space-y-8">
      ...
      <div className="">
        <img
          src={daadaa}
          alt="dada"
          className="rounded-full w-[18rem] h-[18rem] object-f border-[#DD6B4D] border-4 "
        />
      </div>
      ...
      <div className="px-4 dark:text-white text-left sm:text-center">
        <p>
      ...
      <div className="flex space-x-3 py-8 gap-4  flex-wrap">
        <p className="p-3 p-l-3 bg-[#DD6B4D]  dark:text-white rounded-sm">
          javascript
        </p>
        <p className="p-3 bg-[#DD6B4D]  dark:text-white rounded-sm">react js</p>
        <p className="py-2.5 px-8 bg-[#DD6B4D]  dark:text-white rounded-sm">
          c
        </p>
        <p className="py-2.5 px-8 bg-[#DD6B4D]  dark:text-white rounded-sm">
          c++
        ...
        <p className="p-3 bg-[#DD6B4D]  dark:text-white rounded-sm">c#</p>
        <p className="p-3 bg-[#DD6B4D]  dark:text-white rounded-sm">node js</p>
        <p className="py-3 px-10  dark:text-white rounded-sm bg-[#DD6B4D]">
          java
        </p>
        <p className="py-3 px-10  dark:text-white rounded-sm bg-[#DD6B4D]">
          php
